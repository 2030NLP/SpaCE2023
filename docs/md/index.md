...
> ```json
> { "qid": "2-train-21",
>   "outputs": [ {"空间实体":{"text":"老妇人","idxes":[0,1,2]},
>                 "事件":{"text":"跪","idxes":[3]},
>                 "处所":{"text":"在那坑里","idxes":[4,5,6,7]} },
>                {"空间实体":{"text":"那些水","idxes":[13,14,15]},
>                 "事件":{"text":"舀","idxes":[11]},
>                 "处所":{"text":"在那坑里","idxes":[4,5,6,7]},
>                 "方向":{"text":"出","idxes":[12]} },
>                {"空间实体":{"text":"水","idxes":[38]},
>                 "事件":{"text":"舀","idxes":[40]},
>                 "事实性":{"label":"假"},
>                 "处所":{"text":"坑里","idxes":[35,36]} },
>                {"空间实体":{"text":"她","idxes":[46]},
>                 "时间":{"text":"舀","idxes":[40],"label":"之后"},
>                 "终点":{"text":"到那死者旁边","idxes":[48,49,50,51,52,53]},
>                 "方向":{"text":"回","idxes":[47]} },
>                {"空间实体":{"text":"她","idxes":[46]},
>                 "事件":{"text":"抄","idxes":[57]},
>                 "处所":{"text":"在死者的腋窝下","idxes":[58,59,60,61,62,63,64]},
>                 "部位":{"text":"两手","idxes":[55,56]} } ] }
> ```
>
> 同指信息：
> 
...
- ⑤ reason：说明空间场景相同或不相同的理由。生成的内容应该包括以下三个部分：
...
子任务 3 首先根据judge字段的结果评价异同判断是否正确，如果错误，该题得0分；如果正确，采用人工评价对reason字段的生成文本进行打分。评分内容包括文本流畅度、解释准确性、是否准确识别空间实体、对空间方位关系的运用等方面。
