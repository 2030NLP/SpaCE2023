...
## 第三届中文空间语义理解评测（SpaCE2023）参赛协议

您（以下简称“选手”）在自愿报名参加 CCL2023 第三届中文空间语义理解评测（英文简称：SpaCE2023）（简称“比赛”）并点击报名页面的提交按钮之前，请务必仔细阅读并充分理解《第三届中文空间空间语义理解评测（SpaCE2023）参赛协议》（简称“本协议”）的内容，特别是以粗体标注的条款。
