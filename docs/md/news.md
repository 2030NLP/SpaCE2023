...
- `5月 13日` **关于如何提交结果**：请将结果输出为 jsonl 格式（即每行一个 json 对象），以【队伍名称-taskN-dev/test-第N次提交-日期.jsonl】给文件命名，以【队伍名称-验证集/测试集-第N次提交-X月Y日】为邮件标题，将结果文件发送到 lmxiao@stu.pku.edu.cn 。我们每周将会根据提交情况更新1到2次排行榜，仅以更新时您的最后一次提交结果为准。
